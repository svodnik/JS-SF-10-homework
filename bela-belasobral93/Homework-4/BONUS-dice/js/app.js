...
* get the second die by ID and update the CSS class name to secondDie 
...
first = document.querySelector("#first-die");
second = document.querySelector("#second-die");

first.className = 'firstDie';
second.className = 'secondDie';