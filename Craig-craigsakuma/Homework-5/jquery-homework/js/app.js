...
$('#surveyList li').on('click', 'button', function(e) {
   e.preventDefault();
   $(this).parent().remove();
})

$('#surveyList').on('mouseenter mouseleave', 'li', function(e) { //event delegation
   e.preventDefault();
   if (e.type==='mouseenter') {
      $(this).addClass('bg-warning');
      $(this).siblings().removeClass('bg-warning'); //chaining
