...
var CelsiusToFahrenheit = document.getElementById("celsius_to_fahrenheit");

var FahrenheitToCelsius = document.getElementById("fahrenheit_to_celsius");

FahrenheitToCelsius.addEventListener("click", function() {
  let myTemp = document.getElementById("temperature").value;
  let result = document.getElementById("result");
  result.value = FToC(myTemp)
  console.log(result.value);
});

CelsiusToFahrenheit.addEventListener("click", function() {
  let myTemp = document.getElementById("temperature").value;
  let result = document.getElementById("result");
  result.value = CToF(myTemp);
  console.log(result.value);
});
