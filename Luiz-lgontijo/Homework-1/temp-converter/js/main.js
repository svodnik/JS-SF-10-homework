...
function celsiusToFahrenheit(){
   ...
   x = Math.round(((1.8 * c) + 32) * 100) / 100;
   console.log(" F= "+x);
   document.getElementById("result").innerHTML = (c + " Celsius = " + x + " Fahrenheit");
}

function fahrenheitToCelsius(){
   let f = document.getElementById("temperature").value;
   y = Math.round(((f - 32) / 1.8) * 100) / 100;
   console.log(" C= "+y);
   document.getElementById("result").innerHTML = (f + " Fahrenheit = " + y + " Celsius");
}
