...
function convertToCelsius(F){     // function that accepts a temperature value in Fahrenheit and converts it to Celsius.
    var F, C;
    C= (F - 32) / 1.8;
    return C;
}
...
function convertToFahrenheit(C){  // function that accepts a temperature value in Celsius and converts it to Fahrenheit.
   var F,C;
   F=  (1.8 * C) + 32;
   return F;
}
